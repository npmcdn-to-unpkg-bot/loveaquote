class Admin::NationalitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nationality.save
        format.html { redirect_to admin_nationalities_url, notice: 'Nationality was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @nationality.update(nationality_params)
        format.html { redirect_to admin_nationalities_url, notice: 'Nationality was successfully updated.' }
  ...
  def destroy
    @nationality.destroy
    respond_to do |format|
      format.html { redirect_to admin_nationalities_url, notice: 'Nationality was successfully destroyed.' }
