class Admin::ProfessionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @profession.save
        format.html { redirect_to admin_professions_url, notice: 'Profession was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @profession.update(profession_params)
        format.html { redirect_to admin_professions_url, notice: 'Profession was successfully updated.' }
