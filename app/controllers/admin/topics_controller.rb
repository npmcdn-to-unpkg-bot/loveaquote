class Admin::TopicsController < ApplicationController
  ...
  # GET /topics/1/edit
  def edit
    @topic.build_seo if @topic.seo.nil?
  end
  ...
  private
    ...
    def topic_params
      params.require(:topic).permit(:name, :byline, :slug, :popular, :very_popular, :published, topic_combinations_attributes: [:id, :secondary_topic_id, :_destroy], seo_attributes: [:id, :title, :description, :_destroy], topic_aliases_attributes: [:id, :name, :_destroy])
    end
end
