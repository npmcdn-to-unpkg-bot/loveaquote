class Admin::BooksController < ApplicationController
  ...
  private
    ...
    def book_params
      params.require(:book).permit(:name, :fetch_url, :published, :popular, :very_popular, :book_id, :person_id, :image, character_sources_attributes: [:id, :character_id, :_destroy])
    end
end
