class Admin::PeopleController < ApplicationController
  ...
  private
    ...
    def person_params
      params.require(:person).permit(:name, :slug, :fetch_url, :born, :died, :nationality_id, :profession_id, :published, :popular, :very_popular, :image, seo_attributes: [:id, :title, :description, :_destroy], person_professions_attributes: [:id, :profession_id, :_destroy], featured_topics_attributes: [:id, :topic_id, :_destroy])
    end
end
